 ...
 * @package Widget
 */
class Widget_Contents_Modify extends Widget_Abstract
{
    /**
     * 获取查询对象
     *
    ...
    public function filter(array $value)
    {
        ...
        if (!empty($value['categories'])) {
            ...
            $value['categoryId'] = $value['categories'][0]['mid'];
            $value['categoryArray'] = $value['categories'][0];
    ...
    {
        return Typecho_Common::subStr(strip_tags($this->excerpt), 0, $length, $trim);
    }
